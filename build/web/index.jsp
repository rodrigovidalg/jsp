<%-- 
    Document   : index
    Created on : 8/09/2024, 4:22:01 p. m.
    Author     : user
--%>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Agregar un Empleado</h1>
      ...
      <div class="modal-body">
        <form action="sr_empleado" method="post" class="form-group">
                ...
                <input type="text" name="txt_codigo" id="txt_codigo" class="form-control" placeholder="E001" pattern="[E]{1}[0-9]{3}" required>
                ...
                <div class="btn-group" role="group" aria-label="Basic outlined example">
                    <button name="btn_agregar" id="btn_agregar" value="agregar" class="btn btn-outline-success"><i class="bi bi-database-fill-add"></i> Agregar</button>
                    <button name="btn_modificar" id="btn_modificar"  value="modificar" class="btn btn-outline-warning"><i class="bi bi-database-fill-gear"></i> Modificar</button>
                    <button name="btn_eliminar" id="btn_eliminar"  value="eliminar"  class="btn btn-outline-danger" onclick="javascript:if(!confirm('¿Desea Eliminar?'))return false" ><i class="bi bi-database-fill-dash"></i> Eliminar</button>
                </div>
